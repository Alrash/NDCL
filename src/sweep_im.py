...
def make_args_list(n_trials, dataset_names, algorithms, type,
                   n_hparams_from, n_hparams, steps, data_dir,
                   task, holdout_fraction, single_test_envs, hparams):
    args_list = []
...
if __name__ == "__main__":
    ...
    parser.add_argument('--type', type=str, default='idg')
